...
# print(len(emoji_dict))

# user_key = "aple"

# try:
#     print(emoji_dict[user_key])
# except:
#     print(f"Неправильний ключ {user_key} from TRY")

# if user_key in emoji_dict:
#     print(emoji_dict[user_key])
# else:
#     print(f"Неправильний ключ {user_key} from ELSE")

# print(emoji_dict.get(user_key, f"Неправильний ключ {user_key} from GET"))
